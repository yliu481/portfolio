        ...
        <div className="d-flex flex-grow-1">
          ...
          <div className="w-100 text-right">
            <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
              ...
              <svg viewBox="0 0 1441 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4537" height="24" width="24"><path d="M0 0h1441.148953v127.98981H0zM0 447.964334h1441.148953v127.98981H0zM0 896.01019h1441.148953v127.98981H0z" p-id="4538"></path></svg>
              </span>
            </button>
          </div>
        </div>
